...
struct CarouselView: View {
                ...
                ZStack{
                    ForEach(0..<views.count, id: \.self) { i in
                        VStack{
                            Spacer()
                            self.views[i]
                                .frame(width:250, height: self.getHeight(i))
    ...
    func getOffset(_ i:Int) -> CGFloat{
        ...
        {
            //Set offset +1
            return self.dragState.translation.width + (270 + 20)
        }
        else if
            (i) == relativeLoc() - 1
                ||
...
struct CaruselView_Previews: PreviewProvider {
    static var previews: some View {
        CarouselView(itemHeight: 400, views: [
            AnyView(ImageView(picture: .constant("https://avatars.mds.yandex.net/get-mpic/5235334/img_id5575010630545284324.png/orig"))),
            AnyView(ImageView(picture: .constant("https://avatars.mds.yandex.net/get-mpic/5235334/img_id5575010630545284324.png/orig"))),
            AnyView(ImageView(picture: .constant("https://www.manualspdf.ru/thumbs/products/l/1260237-samsung-galaxy-note-20-ultra.jpg")))
        ])
    }
}
